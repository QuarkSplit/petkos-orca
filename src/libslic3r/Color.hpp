...
public:
    ...
    static const ColorRGB ORCA()		{ return {79.0f / 255.0f, 135.f / 255.0f, 165.0f / 255}; }   //Podslicer accent: muted arctic blue #4F87A5
...
public:
    ...
    static const ColorRGBA ORCA()        { return {79.0f / 255.0f, 135.f / 255.0f, 165.0f / 255, 1.0f}; }   //Podslicer accent: muted arctic blue #4F87A5
