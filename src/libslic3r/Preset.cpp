...
static std::vector<std::string> s_Preset_filament_options {/*"filament_colour", */ "default_filament_colour", "filament_finish", "required_nozzle_HRC", "filament_diameter", "pellet_flow_coefficient", "volumetric_speed_coefficients", "filament_type",
