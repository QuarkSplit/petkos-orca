    ...
    , m_show_history_dialog(show)
{
    ...
    m_extruder_switch_btn->SetBackgroundColour(wxColour(79, 135, 165));
...
wxArrayString NewCalibrationHistoryDialog::get_all_filaments(const MachineObject *obj)
{
    ...
    if (machine_diameter == 0.0f) {
        BOOST_LOG_TRIVIAL(error) << __FUNCTION__ << ": connected printer has not reported its nozzle diameter";
        return {};
    }
