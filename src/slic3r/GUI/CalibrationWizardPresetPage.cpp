...
void CalibrationPresetPage::create_selection_panel(wxWindow* parent)
{
    ...
    StateColor btn_sync_bd_col(std::pair<wxColour, int>(wxColour("#4F87A5"), StateColor::Pressed),
                               std::pair<wxColour, int>(wxColour("#4F87A5"), StateColor::Hovered),
...
void CalibrationPresetPage::update_sync_button_status()
{
    auto set_status = [this](bool synced) {
        ...
        StateColor not_synced_colour(std::pair<wxColour, int>(wxColour("#4F87A5"), StateColor::Normal));
        if (synced) {
