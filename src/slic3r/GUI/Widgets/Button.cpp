    ...
    : paddingSize(10, 8)
{
    background_color = StateColor(
        ...
        std::make_pair(0x4F87A5, (int) StateColor::Checked),
...
wxString btn_regular[10]  = {"#DFDFDF", "#DFDFDF", "#D4D4D4", "#DFDFDF", "#DFDFDF", "#6B6A6A", "#262E30", "#262E30", "#4F87A5", "#4F87A5"};
wxString btn_confirm[10]  = {"#DFDFDF", "#4F87A5", "#6B9DB8", "#4F87A5", "#4F87A5", "#6B6A6A", "#FEFEFE", "#FEFEFE", "#5FA5C9", "#8FD0EA"};
wxString btn_alert[10]    = {"#DFDFDF", "#DFDFDF", "#E14747", "#DFDFDF", "#DFDFDF", "#6B6A6A", "#262E30", "#FFFFFD", "#4F87A5", "#4F87A5"};
