    ...
    , state_handler(this)
{
    ...
    border_color.append(wxColour(63, 111, 138), StateColor::Pressed);
    border_color.append(wxColour(107, 157, 184), StateColor::Hovered);
    border_color.append(0x4F87A5, StateColor::Normal);
    ...
    background_color.append(wxColour(63, 111, 138), StateColor::Pressed);
    background_color.append(wxColour(107, 157, 184), StateColor::Hovered);
    background_color.append(0x4F87A5, StateColor::Normal);
